...
from data.data_preprocessing import sequence2id
from utils import process_seq, batch_iter
...
def train():
    ...
    content_train, label_train = sequence2id(pm.train_data, pm.word2id_data)
    content_test, label_test = sequence2id(pm.test_data, pm.word2id_data)
